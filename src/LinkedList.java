...
public class LinkedList<V> {
    ...
    public V getValueAtPosition(int index) throws EmptyListException,InvalidIndexException {
    ...
    public void remove(V value) throws ValueNotFoundException, EmptyListException {
        if (isEmpty()) {
            throw new EmptyListException("The list is empty");
        }
        Element<V> e = first;
